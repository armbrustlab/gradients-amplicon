...
echo "filename with ext: ${filename}"
...
qiime dada2 denoise-single --i-demultiplexed-seqs "./int_files/${filename_no_ext}-trimmed.qza" --p-trunc-len 200 --p-n-threads 8 \ 
...
qiime feature-classifier classify-consensus-vsearch --i-reference-reads ../db/pr2/pr2-mothur.qza \ 
